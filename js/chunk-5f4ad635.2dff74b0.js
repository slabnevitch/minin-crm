(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["chunk-5f4ad635"],{
...
/* harmony default export */ var Loginvue_type_script_lang_js_ = ({
  ...
  mounted: function mounted() {
    console.log(messages["a" /* default */]['logout']);

    if (messages["a" /* default */][this.$route.query.message]) {
      this.$message(messages["a" /* default */][this.$route.query.message]); //вывод сообщения о выходе пользователя из системы с использованием метода из самодельного плагина
    }
  },
  validations: {
    email: {
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                console.log(_this.$v.password.$params.minLength.min);
...
//# sourceMappingURL=chunk-5f4ad635.2dff74b0.js.map